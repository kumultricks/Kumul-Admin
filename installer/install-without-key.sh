...
v1=$(curl -sSL "https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/SCRIPT-v8.5x/Version")
...
repo() {
  link="https://raw.githubusercontent.com/kumultricks/Multi-Script/main/Source-List/20.04.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/installer/install-without-key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
clear && clear
msg -bar2
echo -e " \e[5m\033[1;100m   =====>> ►► 🇵🇬 KUMUL ADMIN 🇵🇬 ◄◄ <<=====   \033[1;37m"
msg -bar2
print_center -ama "AVAILABLE SCRIPT LIST"
msg -bar
#-BASH SOPORTE ONLINE
wget https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/LINKS-LIBRARIES/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
chmod +x /usr/bin/SPR
...
install_official() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/SCRIPT-v8.5x/VPS-AGN.tar.xz >/dev/null 2>&1
  ...
  wget https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/LINKS-LIBRARIES/monitor.sh -P /bin/
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/LINKS-LIBRARIES/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/SCRIPT-v8.5x/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/SCRIPT-v8.5x/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/kumultricks/Kumul-Admin/master/SCRIPT-v8.5x/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
